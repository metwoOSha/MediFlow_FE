...
export async function updateSpecialization(id: string, body: Partial<Omit<Specialization, 'id' | 'doctors_count'>>) {
    const res = await patch(GET_SPECIALIZATIONS_URL_BY_ID(id), body);
    return res.json();
}
